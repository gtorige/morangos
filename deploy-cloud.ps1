...
# Guia interativo para leigos â€” faz tudo passo a passo
# ============================================================
...
function Show-Step($num, $title) {
    ...
    Write-Host "  PASSO $num â€” $title" -ForegroundColor Cyan
    Write-Host "========================================" -ForegroundColor Cyan
    Write-Host ""
}
...
Write-Host "  MORANGOS â€” DEPLOY NA NUVEM" -ForegroundColor Green
Write-Host "  ========================================" -ForegroundColor Green
Write-Host ""
...
# ============================================================
# PASSO 1 â€” VERIFICAR/INSTALAR NODE.JS
# ============================================================
...
# ============================================================
# PASSO 2 â€” VERIFICAR/INSTALAR TURSO CLI
# ============================================================
...
# ============================================================
# PASSO 3 â€” VERIFICAR/INSTALAR VERCEL CLI
# ============================================================
...
# ============================================================
# PASSO 4 â€” CRIAR CONTA E LOGIN NO TURSO
# ============================================================
...
# ============================================================
# PASSO 5 â€” CRIAR BANCO DE DADOS
# ============================================================
...
# ============================================================
# PASSO 7 â€” INSTALAR DEPENDENCIAS
# ============================================================
...
# ============================================================
# PASSO 8 â€” CONFIGURAR VARIAVEIS DE AMBIENTE
# ============================================================
...
# ============================================================
# PASSO 9 â€” CONFIGURAR BANCO DE DADOS
# ============================================================
...
# ============================================================
# PASSO 11 â€” CONFIGURACAO GOOGLE MAPS (OPCIONAL)
# ============================================================
Show-Step 11 "GOOGLE MAPS (OPCIONAL)"

Write-Host "O app usa o Google Maps para otimizar rotas de entrega." -ForegroundColor White
Write-Host "Isso e opcional â€” o app funciona sem ele." -ForegroundColor DarkGray
Write-Host ""
...
Write-Host "  3. Pronto â€” use de qualquer lugar!" -ForegroundColor DarkGray
Write-Host ""
